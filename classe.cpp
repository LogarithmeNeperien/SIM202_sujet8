    ...
    { 
        ...
        */
        ...
        if(intersection_segment(seg_g,seg_d,0.01,0.01))
        {
            ...
            //printf("normale_d.P2:(%lf,%lf)\n",normale_d.P2.x,normale_d.P2.y);  
            for(int k=1;k<7;++k)
            {
                ...
                //printf("angle_final:(%lf,%lf)\n",normale_g.P2.x,normale_g.P2.y);

                normale_d = Segment(points_obs[j],angle_final);
            }

                sommets_coin.push_back(normale_g.P2);
                //printf("normale_g.P2:(%lf,%lf)\n",normale_g.P2.x,normale_g.P2.y);
